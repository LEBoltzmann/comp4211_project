...
if __name__ == "__main__":
    ...
    if args.adapt_algorithm in ['T3A', 'TentPreBN', 'TentClf', 'PLClf', 'AdaNPC', 'AdaNPCBN']:
    ...
    # get the adapt_algorithm
    last_results_keys = None
    adapt_algorithm_class = adapt_algorithms.get_algorithm_class(args.adapt_algorithm)
